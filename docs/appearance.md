...
| `list-wallpapers`                                              | Pack pairs + entries                                        |
| `list-themes`                                                  | Daily-rotation base16 families                              |
...
1. **Hot layer**: `~/.colors.toml`, IDE / Ghostty live palette, swaybg / WallpaperKit, macOS tint
