...
let
  ...
  hypervisorSupportsSystem =
    hypervisor: s:
    if isDarwinSystem s then
      builtins.elem hypervisor hypervisorsOnDarwin
    else
      !(isDarwinOnly hypervisor);
...
//
  ...
  builtins.foldl' (
    ...
    in
    result // import ./vm.nix args // import ./iperf.nix args // import ./machined.nix args
