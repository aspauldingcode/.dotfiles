...
in
{
  services.skhd = {
    ...
    in ''
      ...
      ${modifier} + ${smod} - 1 : ${yabai} -m window --space 1; ${yabai} -m space --focus 1; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 2 : ${yabai} -m window --space 2; ${yabai} -m space --focus 2; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 3 : ${yabai} -m window --space 3; ${yabai} -m space --focus 3; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 4 : ${yabai} -m window --space 4; ${yabai} -m space --focus 4; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 5 : ${yabai} -m window --space 5; ${yabai} -m space --focus 5; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 6 : ${yabai} -m window --space 6; ${yabai} -m space --focus 6; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 7 : ${yabai} -m window --space 7; ${yabai} -m space --focus 7; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 8 : ${yabai} -m window --space 8; ${yabai} -m space --focus 8; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 9 : ${yabai} -m window --space 9; ${yabai} -m space --focus 9; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - 0 : ${yabai} -m window --space 10; ${yabai} -m space --focus 10; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      
      # move focus to workspace n
      ${modifier} - 1 : ${yabai} -m space --focus 1; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} - 2 : ${yabai} -m space --focus 2; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} - 3 : ${yabai} -m space --focus 3; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000    
      ${modifier} - 4 : ${yabai} -m space --focus 4; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} - 5 : ${yabai} -m space --focus 5; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} - 6 : ${yabai} -m space --focus 6; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000  
      ${modifier} - 7 : ${yabai} -m space --focus 7; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} - 8 : ${yabai} -m space --focus 8; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} - 9 : ${yabai} -m space --focus 9; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} - 0 : ${yabai} -m space --focus 10; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ...
      ${mod4} + ${smod} - ${left} :   ${yabai} -m window --space prev; ${yabai} -m space --focus prev; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${mod4} + ${smod} - ${down} :   ${yabai} -m window --space next; ${yabai} -m space --focus next; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${mod4} + ${smod} - ${up} :     ${yabai} -m window --space prev; ${yabai} -m space --focus prev; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${mod4} + ${smod} - ${right} :  ${yabai} -m window --space next; ${yabai} -m space --focus next; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - left :      ${yabai} -m window --space prev; ${yabai} -m space --focus prev; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - down :      ${yabai} -m window --space next; ${yabai} -m space --focus next; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - up :        ${yabai} -m window --space prev; ${yabai} -m space --focus prev; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
      ${modifier} + ${smod} - right :     ${yabai} -m window --space next; ${yabai} -m space --focus next; ${desktoppr} ${wallpaper}; ${desktoppr} color 000000
