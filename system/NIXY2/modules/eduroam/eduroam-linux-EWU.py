...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Eastern Washington University"
Config.profilename = "EWU Eduroam"
Config.url = "https://support.ewu.edu"
Config.email = "helpdesk@ewu.edu"
Config.title = "eduroam CAT"
Config.server_match = "lipfence02v.eastern.ewu.edu"
...
Config.user_realm = "ewu.edu"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:lipfence02v.eastern.ewu.edu']
Config.use_other_tls_id = False
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
