...
in
{
  programs.bemenu = {
    ...
    settings = {
      ...
      sb = "#${colors.base00}"; # Selected background color
      sf = "#${colors.base05}"; # Selected foreground color (lighter)
      scb = "#${colors.base0C}"; # Selected cursor background color
      scf = "#${colors.base00}"; # Selected cursor foreground color (darker)
    };
  };
}
